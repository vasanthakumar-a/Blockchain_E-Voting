...
def userRegister(request):
    ...
    if request.method == 'POST':
        ...
        if password1==password2:
            tx_hash = contract.functions.register(first_name,last_name,email,username,phone_number,reg_no,password1).transact()
